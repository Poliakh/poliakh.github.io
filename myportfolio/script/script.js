...
ajaxSelect.load('data.json'); // look it https://gist.github.com/msmfsd/fca50ab095b795eb39739e8c4357a808
// 
//--wow--
...
addDelayAnimation('.cardWrap', '.card', 0.2, 0.5); //turn off animated navigation for items menu  if burger is visible
